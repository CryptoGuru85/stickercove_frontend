...
import { SizeQuantity as SizeQuantityContainer } from "../../../containers/SizeQuantity";
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Customize your order by selecting a custom size and quantity of stickers."
        />
        <meta
          name="keywords"
