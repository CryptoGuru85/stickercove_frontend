import { UploadSticker as UploadStickerContainer }  from "../../containers/UploadSticker";
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Upload your artwork, recieve a proof, and have your custom stickers produced."
        />
        <meta
          name="keywords"
