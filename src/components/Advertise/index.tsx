...
import { Images } from "constants/StickerImages";

export const SliderRightDivs = styled.div`
  color: #6a7c93;
...
export const generateStickerOption = (handleNext, counts) =>
...
export const generateProducts = (handleNext) => {
