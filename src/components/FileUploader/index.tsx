...
export const FileUploader = ({ url, onChange }) => {
          ...
          {onUploading ? (
            ...
            <>
              ...
              <div className="proof-warning">
                Do not worry, this is not a representation of your sticker! A proof will be sent before production. Your proof
                will include unlimited revisions until satisfied.
              </div>
            </>
          ) : (
            <>
