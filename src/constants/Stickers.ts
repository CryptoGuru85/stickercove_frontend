...
export const Stickers = [
  ...
  },
  {
    ...
    description:
      "Click above to start your order. The perfect sticker for your car.",
  },
  {
    image: SHEET,
    title: "Sticker Sheets",
    description:
      "Click above to start your order. Multiple stickers on a single backer.",
  },
  {
    image: ROUNDED,
  ...
  },
  {
    ...
    description:
      "Click above to start your order. Image transfering with transfer tape.",
  },
  {
    image: VINYL,
    title: "Vynil Lettering",
    description:
      "Click above to start your order. Letter transfering with transfer tape.",
  },
  {
    image: SLINGS,
    title: "Static Clings",
